...
#include "Parsers/BufrParser/BufrTypes.h"
        ...
        namespace bufr
        {
            ...
            class BufrAccumulator
            {
             public:
                ...
                void addRow(std::vector<encoder::FloatType>& newRow);
                ...
                encoder::Array getData(Eigen::Index startCol, const Channels& channels = {1});

                /// \brief Start over
                void reset();

                // Getters
                inline Eigen::Index getNumColumns() const
                { return numColumns_; }

             private:
                /// \brief Eigen Array that holds the accumulated data
                encoder::Array dataArray_;
