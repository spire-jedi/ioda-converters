...
#include "Parsers/BufrParser/Exports/Filters/GreaterFilter.h"
#include "Parsers/BufrParser/Exports/Filters/LesserFilter.h"
#include "Parsers/BufrParser/Exports/Filters/RangeFilter.h"
#include "Parsers/BufrParser/Exports/Splits/CategorySplit.h"
#include "Parsers/BufrParser/Exports/Variables/MnemonicVariable.h"
#include "Parsers/BufrParser/Exports/Variables/DatetimeVariable.h"
#include "Parsers/BufrParser/Exports/Variables/Transforms/Transform.h"
#include "Parsers/BufrParser/Exports/Variables/Transforms/TransformBuilder.h"
            ...
            void Export::addSplits(const eckit::Configuration& conf)
            {
                for (const auto& key : conf.keys())
                {
                    ...
                    if (subConf.has(ConfKeys::Split::Category))
                    {
                        ...
                        {
                            const auto& mapConf = catConf.getSubConfiguration(
                                ConfKeys::Split::NameMap);
