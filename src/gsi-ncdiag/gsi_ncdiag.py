...
gsi_add_vars = {
    ...
    'EffectiveQC': 'EffectiveQC',
    'Nonlinear_QC_Rel_Wgt': 'GsiQCWeight',
    'Errinv_Adjust': 'GsiAdjustObsError',
    'Errinv_Final': 'EffectiveError',
    'Press_Max_Weight_Function': 'Press_Max_Weight_Function',
    'ObsBias': 'ObsBias',
    'Forecast_adjusted': 'HofX',
    'Forecast_unadjusted_1': 'HofX_1',
    'Forecast_unadjusted_2': 'HofX_2',
    'Forecast_unadjusted_3': 'HofX_3',
    'Forecast_unadjusted_4': 'HofX_4',
    'Forecast_unadjusted_5': 'HofX_5',
    'Forecast_unadjusted_6': 'HofX_6',
    'Forecast_unadjusted_7': 'HofX_7',
    'Forecast_unadjusted_8': 'HofX_8',
    'Forecast_unadjusted_9': 'HofX_9',
    'Forecast_unadjusted_10': 'HofX_10',
    'Forecast_unadjusted_11': 'HofX_11',
    'Forecast_unadjusted_12': 'HofX_12',
    'Forecast_unadjusted_13': 'HofX_13',
    'Forecast_unadjusted_14': 'HofX_14',
    'Forecast_unadjusted_15': 'HofX_15',
    'Forecast_unadjusted_16': 'HofX_16',
    'Forecast_unadjusted_17': 'HofX_17',
    'Forecast_unadjusted_18': 'HofX_18',
    'Forecast_unadjusted_19': 'HofX_19',
    'Forecast_unadjusted_20': 'HofX_20',
    'Forecast_unadjusted': 'GsiHofX',
    'Inverse_Observation_Error': 'EffectiveError',
...
gsi_add_vars_uv = {
    ...
    'Errinv_Final': 'EffectiveError',
    'u_ObsBias': 'ObsBias',
    'u_Forecast_adjusted': 'HofX',
    'u_Forecast_unadjusted_1': 'HofX_1',
    'u_Forecast_unadjusted_2': 'HofX_2',
    'u_Forecast_unadjusted_3': 'HofX_3',
    'u_Forecast_unadjusted_4': 'HofX_4',
    'u_Forecast_unadjusted_5': 'HofX_5',
    'u_Forecast_unadjusted_6': 'HofX_6',
    'u_Forecast_unadjusted_7': 'HofX_7',
    'u_Forecast_unadjusted_8': 'HofX_8',
    'u_Forecast_unadjusted_9': 'HofX_9',
    'u_Forecast_unadjusted_10': 'HofX_10',
    'u_Forecast_unadjusted_11': 'HofX_11',
    'u_Forecast_unadjusted_12': 'HofX_12',
    'u_Forecast_unadjusted_13': 'HofX_13',
    'u_Forecast_unadjusted_14': 'HofX_14',
    'u_Forecast_unadjusted_15': 'HofX_15',
    'u_Forecast_unadjusted_16': 'HofX_16',
    'u_Forecast_unadjusted_17': 'HofX_17',
    'u_Forecast_unadjusted_18': 'HofX_18',
    'u_Forecast_unadjusted_19': 'HofX_19',
    'u_Forecast_unadjusted_20': 'HofX_20',
    'u_Forecast_unadjusted': 'GsiHofX',
    'v_ObsBias': 'ObsBias',
    'v_Forecast_adjusted': 'HofX',
    'v_Forecast_unadjusted_1': 'HofX_1',
    'v_Forecast_unadjusted_2': 'HofX_2',
    'v_Forecast_unadjusted_3': 'HofX_3',
    'v_Forecast_unadjusted_4': 'HofX_4',
    'v_Forecast_unadjusted_5': 'HofX_5',
    'v_Forecast_unadjusted_6': 'HofX_6',
    'v_Forecast_unadjusted_7': 'HofX_7',
    'v_Forecast_unadjusted_8': 'HofX_8',
    'v_Forecast_unadjusted_9': 'HofX_9',
    'v_Forecast_unadjusted_10': 'HofX_10',
    'v_Forecast_unadjusted_11': 'HofX_11',
    'v_Forecast_unadjusted_12': 'HofX_12',
    'v_Forecast_unadjusted_13': 'HofX_13',
    'v_Forecast_unadjusted_14': 'HofX_14',
    'v_Forecast_unadjusted_15': 'HofX_15',
    'v_Forecast_unadjusted_16': 'HofX_16',
    'v_Forecast_unadjusted_17': 'HofX_17',
    'v_Forecast_unadjusted_18': 'HofX_18',
    'v_Forecast_unadjusted_19': 'HofX_19',
    'v_Forecast_unadjusted_20': 'HofX_20',
                        ...
                        if key in self.df.variables:
                            ...
                            if ("Forecast" in key) and (v == 'uv'):
                                if (checkuv[outvars[o]] != key[0]):
                                    continue
                            if ("Errinv" in key) or ("Inverse_" in key):
