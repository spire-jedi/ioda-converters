...
### export version info
set(iodaconv_VERSION           "0.0.0")
set(iodaconv_GIT_SHA1          "e0e2265786ac5deb54060fac0bfca3d5db1778dc")
set(iodaconv_GIT_SHA1_SHORT    "e0e2265")
...
if(NOT iodaconv_BINARY_DIR)
  find_file(iodaconv_TARGETS_FILE
    ...
    HINTS ${iodaconv_CMAKE_DIR};/scratch2/NCEPDEV/marineda/Youlong.Xia/save/ioda-converters/bulid1
    NO_DEFAULT_PATH)
